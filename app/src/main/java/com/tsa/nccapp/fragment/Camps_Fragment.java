...
public class Camps_Fragment extends Fragment {

    View view;

    private String[] subTitle = new String[]{"SHOOTING", "TSC", "YEP"};
    ...
    public Camps_Fragment() {
        // Required empty public constructor
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_camps_, content_frame, false);
        init();
        return view;
    }
