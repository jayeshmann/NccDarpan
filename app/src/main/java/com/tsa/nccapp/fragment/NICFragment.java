...
public class NICFragment extends Fragment {
    View view;
    private WebView webView;
    private String url=GLOBAL.baseURL+"content/";

    private String path[]=new String[]{"CENTRALLY_ORGANISED_CAMPS/ARMY_WING/NIC/NICSNIC.docx",
            "CENTRALLY_ORGANISED_CAMPS/ARMY_WING/NIC/NIC_II.docx"};
    ...
    private void init() {
        ...
        showPage(0);
        SwitchMultiButton mSwitchMultiButton = (SwitchMultiButton) view.findViewById(R.id.p_tab);
        mSwitchMultiButton.setText("NICSNIC","NIC_II");
