 ...
 */
public class Ldc_Fragment extends Fragment {

    View view;

    private String[] subTitle = new String[]{"LDC SET 1", "LDC SET 2"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.fragment_ldc, content_frame, false);
        init();
        return view;
    }
