...
public class FetureFragment extends Fragment {
    private View view;
    private ZoomTextView item1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.fragment_feture, content_frame, false);
        init();
        return view;
    ...
    private void init() {
        ...
        item1.setText(Html.fromHtml(getString(R.string.feature)));
