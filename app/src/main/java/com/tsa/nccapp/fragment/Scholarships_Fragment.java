 ...
 */
public class Scholarships_Fragment extends Fragment {

    View view;

    private String[] subTitle = new String[]{"AWARD", "CM FUND", "CWS", "SAHARA"};
    ...
    private String[] path = new String[]{
            "INCENTIVES_BENEFITS/SCHOLARSHIPS/AWARD.docx",
            "INCENTIVES_BENEFITS/SCHOLARSHIPS/CM%20FUND.docx",
            "INCENTIVES_BENEFITS/SCHOLARSHIPS/CWS.docx",
            "INCENTIVES_BENEFITS/SCHOLARSHIPS/Sahara.pdf",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.fragment_scholarships, content_frame, false);
        init();
        return view;
    }
