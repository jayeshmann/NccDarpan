 ...
 */
public class CadetHandbook2017Fragment extends Fragment {

    View view;

    private String[] subTitle = new String[]{"JD JW - Common Syllabus","JD JW - Special Subject","SD SW - Common Subject","SD SW - Special Subject"};
    ...
    private String[] path = new String[]{
            "cadets_handbbook2017/JD_JW_Common_Syllabus.docx",
            "cadets_handbbook2017/JD_JW_Special_Subject.docx",
            "cadets_handbbook2017/SD_SW_Common_Subject.docx",
            "cadets_handbbook2017/SD_SW_Special_Subject.docx",
    ...
    public CadetHandbook2017Fragment() {
