 ...
 */
public class Institution_Fragment extends Fragment {


    View view;

    private String[] subTitle = new String[]{"APPLICATION FOR RAISING NCC IN INSTITUTE"};
    ...
    private String[] path = new String[]{
            "INSTITUTION/APPLICATION_FOR_raising_NCC_in_institute.pdf",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.fragment_institution, content_frame, false);
        init();
        return view;
    }
