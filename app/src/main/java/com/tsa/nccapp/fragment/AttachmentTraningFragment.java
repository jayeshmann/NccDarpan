...
public class AttachmentTraningFragment extends Fragment {
   View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.att_traning_fragment, content_frame, false);
        init();
    ...
    private void init() {
        ...
        item1.setText(Html.fromHtml(getString(R.string.attachment)));
