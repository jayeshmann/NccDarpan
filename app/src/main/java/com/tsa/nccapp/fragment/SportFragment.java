...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup content_frame,
        ...
        view = inflater.inflate(R.layout.fragment_sport, content_frame, false);
        init();
    ...
    private void init() {
        ...
        item1=view.findViewById(R.id.sport_tv);
        item1.setText(Html.fromHtml(getString(R.string.sport)));
